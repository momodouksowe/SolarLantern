      ...
      <p> Click your Region and town to find a Burro reseller near you.</p>
        ...
        <div data-role="collapsible" class="color1"  >
            ...
            <h3 >Ashanti Region</h3>
              ...
              $datasetR=  mysql_query( " SELECT * FROM solarLanternPromo WHERE Region LIKE 'Ashanti' ORDER BY Town ",$link);
              ...
              $city='bluestamps';
               ...
               while ( $R=mysql_fetch_assoc($datasetR) ){  //begining of while loop for Region
                        ...
                        //prevent doublling city
                            while (strcmp($city, $R["Town"] ) ==0){ 

                              $R=mysql_fetch_assoc($datasetR);

                            }
                                $city = $R["Town"]; //to show Area
         ...
         echo  '<div   data-role="collapsible" class="color1" data-content-theme="b" > ' ; 
                 ...
                 echo ' <h2>'; echo $city; echo '</h2> ';
                         ...
                         $datasetT=mysql_query(" SELECT * FROM solarLanternPromo WHERE Region LIKE 'Ashanti' and Town LIKE '{$city}' ORDER BY Town,Area ",$link);
                ...
                $dataset=mysql_query(" SELECT * FROM solarLanternPromo WHERE Region LIKE 'Ashanti' and Town LIKE '{$city}' and Area like '{$Area}' ORDER BY Town,Area  ",$link);
            ...
            <h3 >Brong Ahafo</h3>
                ...
                $begin='Brong Ahafo' ;
              $datasetR=  mysql_query(" SELECT * FROM solarLanternPromo WHERE Region LIKE '{$begin}' ORDER BY Town ",$link);
        ...
        //      $R=mysql_fetch_assoc($datasetR);
         ...
         echo  '<div   data-role="collapsible" class="color1" data-content-theme="b" > ' ; 
                 ...
                 echo ' <h2>'; echo $city; echo '</h2> ';
                         ...
                         $datasetT=mysql_query(" SELECT * FROM solarLanternPromo WHERE Region LIKE '{$begin}' and Town LIKE '{$city}' ORDER BY 'Town,Area' ",$link);
                ...
                $dataset=mysql_query(" SELECT * FROM solarLanternPromo WHERE Region LIKE '{$begin}' and Town LIKE '{$city}' ORDER BY 'Town,Area' ",$link);
...
<!-- Central -->
      ...
      <div data-role="collapsible" class="color1"  >
            ...
            <h3 >Central</h3>
                ...
                $begin='Central' ;
              $datasetR=  mysql_query(" SELECT * FROM solarLanterPromo WHERE Region LIKE '{$begin}' ORDER BY Town ",$link);
...
<!--  Greater Accra  -->
 ...
 <div data-role="collapsible" class="color1"  >
        ...
        /*                   while ($trap == $intro["Town"] ){ 
                ...
                $dataset=mysql_query(" SELECT * FROM solarLanternPromo WHERE Region LIKE '{$begin}' and Town LIKE '{$city}' and Area LIKE '{$Area}'  ORDER BY Town,Area ",$link);
